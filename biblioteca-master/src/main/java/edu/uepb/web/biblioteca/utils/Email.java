...
public class Email {
	...
	private /*@ spec_public @*/ String emailDestino;
	private /*@ spec_public @*/ Reserva reserva;
	private /*@ spec_public @*/ Divida divida;

	private /*@ pure @*/ Session emailConfig() {
	 ...
	 * @return
	 */
	public /*@ pure @*/ boolean sendNotificacaoReserva(Reserva reserva) {
	 ...
	 * @return
	 */
	public /*@ pure @*/ boolean sendNotificacaoDevolucao(Item item) {
		Session session = emailConfig();
	 ...
	 * @return
	 */
	public /*pure*/ boolean sendRelatorio() {
		Session session = emailConfig();
	...
	public /*@ pure @*/ String getEmailDestino() {
		return emailDestino;
	}

	/*@ assignable this.emailDestino;
	  @ ensures this.emailDestino = emailDestino;
	  @*/
	public void setEmailDestino(String emailDestino) {
		this.emailDestino = emailDestino;
	}

	public /*@ pure @*/ Reserva getReserva() {
		return reserva;
	}

	/*@ assignable this.reserva;
	  @ ensures this.reserva = reserva;
	  @*/
	public void setReserva(Reserva reserva) {
		this.reserva = reserva;
	}

	public /*@ pure @*/ Divida getDivida() {
		return divida;
	}

	/*@ assignable this.divida;
